...
INSERT INTO `educations`
  (`profile_id`,`institution_name`,`degree`,`field_of_study`,`end_date`,`description`,`display_order`,`is_public`)
SELECT
  @profile_id,
  'Sana''a University',
  'Bachelor''s degree',
  'Information Systems',
  STR_TO_DATE('2017','%Y'),
  'Graduated in 2017 with overall grade 91.48%',
  2,
  1
WHERE @profile_id IS NOT NULL
AND NOT EXISTS(
...
(`title`,`slug`,`short_description`,`description`,`status`,`display_order`,`is_public`)
VALUES
('AfrahOnline website','afrahonline-website','Contributed to AfrahOnline website.','Contributed to the development of AfrahOnline website with the team.','completed',1,1),
('ERP System','erp-system','ERP modules.','Designed and implemented ERP modules including HR, Asset Management, and Stock & Purchase systems.','completed',2,1),
('HR System','hr-system','HR module.','Designed HR module.','completed',3,1),
('Asset Management System','asset-management-system','Asset Management.','Asset Management System.','completed',4,1),
('Stock & Purchase System','stock-purchase-system','Stock & Purchase.','Stock & Purchase System.','completed',5,1),
('e-Invoice System','e-invoice-system','Saudi e-Invoice.','Developed e-Invoice systems.','completed',6,1),
('Water Project Management System','water-project-management-system','Water projects.','Water project management system.','completed',7,1),
('Electricity Project Management System','electricity-project-management-system','Electricity projects.','Electricity project management system.','completed',8,1),
('Hospital System','hospital-system','Hospital system.','Hospital management system.','completed',9,1),
('Clinic System','clinic-system','Clinic system.','Clinic management system.','completed',10,1),
('Flutter Apps','flutter-apps','Flutter apps.','Cross-platform Flutter apps.','completed',11,1),
('APIs','apis','Backend APIs.','Backend API development.','completed',12,1);
